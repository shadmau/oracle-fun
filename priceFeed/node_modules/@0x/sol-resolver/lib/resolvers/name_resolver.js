...
var NameResolver = /** @class */ (function (_super) {
    ...
    NameResolver.prototype.resolveIfExists = function (lookupContractName) {
        var _this = this;
        var lookupContractNameNormalized = path.basename(lookupContractName, SOLIDITY_FILE_EXTENSION);
        var contractSource;
        var onFile = function (filePath) {
            ...
            if (contractName === lookupContractNameNormalized) {
                ...
                var source = fs.readFileSync(absoluteContractPath).toString('ascii');
