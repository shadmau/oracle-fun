...
var RevertError = /** @class */ (function (_super) {
     ...
     * @param revertClass A class that inherits from RevertError.
     */
    RevertError.registerType = function (revertClass) {
    ...
    Object.defineProperty(RevertError.prototype, "_hasAllArgumentValues", {
        get: function () {
            ...
            try {
                for (var _b = __values(this.abi.arguments), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var arg = _c.value;
...
function declarationToAbi(declaration) {
    ...
    var _a = __read(m.slice(1), 2), name = _a[0], args = _a[1];
...
function checkArgEquality(type, lhs, rhs) {
    ...
    if (type === 'address') {
        ...
        try {
            ...
            for (var _b = __values(_.zip(lhs, rhs)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var _d = __read(_c.value, 2), slhs = _d[0], srhs = _d[1];
