...
interface FlagsInterface extends Interface {
  ...
  events: {
    ...
    FlagOff: TypedEventDescription<{
      encodeTopics([subject]: [string | null]): string[];
    }>;

    FlagOn: TypedEventDescription<{
      encodeTopics([subject]: [string | null]): string[];
    }>;
    ...
    RaisingAccessControllerChanged: TypedEventDescription<{
...
export class Flags extends Contract {
  ...
  filters: {
    ...
    FlagOff(subject: string | null): EventFilter;

    FlagOn(subject: string | null): EventFilter;
    ...
    RaisingAccessControllerChanged(
