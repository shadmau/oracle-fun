...
interface AccessControlledAggregatorInterface extends Interface {
  functions: {
...
export class AccessControlledAggregator extends Contract {
  connect(
    signerOrProvider: Signer | Provider | string
  ): AccessControlledAggregator;
  attach(addressOrName: string): AccessControlledAggregator;
  deployed(): Promise<AccessControlledAggregator>;
